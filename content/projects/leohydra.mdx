...
description: Production e-commerce platform I hand-coded from scratch and run end-to-end for a Dubai art studio. 40 to 50 orders a day during drop weeks. Every limited-edition drop (six prints, edition of 50 each, 300 units) sells out inside 7 days of going live. Every line of the application is mine. Dual-rail crypto + bank checkout, server-side Meta CAPI, transactional email pipeline, three rounds of self-led adversarial security review. 12 Postgres tables, 30 migrations, 22 API routes, 50 React components.
date: "2025-10-01"
...
<StatBand
  stats={[
    { value: "40–50", label: "Orders / day in a drop week", hint: "concentrated rush across six active prints" },
    { value: "300", label: "Prints per drop", hint: "6 designs, edition of 50 each, sold out inside 7 days" },
    { value: "6", label: "Originals sold to date", hint: "inquiry funnel, priced individually, about one a month" },
...
Every drop is six new print designs, edition of 50 each, 300 prints in total. They clear inside 7 days of going live. Originals don't ship through this funnel at all: they're priced on inquiry, handled one at a time, and roughly one moves a month.
