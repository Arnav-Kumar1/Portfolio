...
<StatBand
  stats={[
    { value: "6", label: "Limited-edition drops", hint: "since October 2025, all sold out" },
    { value: "300", label: "Prints sold", hint: "6 drops, edition of 50 each, every drop cleared inside 7 days" },
    { value: "6", label: "Originals sold", hint: "high-ticket, priced on inquiry, roughly one a month" },
